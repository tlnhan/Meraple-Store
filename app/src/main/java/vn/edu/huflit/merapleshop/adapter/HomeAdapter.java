...
import vn.edu.huflit.merapleshop.activities.ViewAllActivity;
...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.home_cat_items,
                parent, false));
    }
