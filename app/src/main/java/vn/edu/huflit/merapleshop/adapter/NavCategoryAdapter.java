...
import vn.edu.huflit.merapleshop.activities.NavCategoryActivity;
import vn.edu.huflit.merapleshop.models.NavCategoryModel;
...
public class NavCategoryAdapter extends RecyclerView.Adapter<NavCategoryAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.nav_cat_item,
                parent, false));
    }
